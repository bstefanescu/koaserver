...
class Router {
    ...
    dispatch(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.onError(ctx, err);
            }
        });
    }
    middleware() {
    ...
    onError(ctx, err) {
        return (0, error_1.errorHandler)(ctx, err, Object.assign({ htmlRoot: (0, path_1.join)(this.webRoot, '/errors') }, this.errorHandlerOpts));
    }
    withGuard(guard) {
        this.guard = guard;
        return this;
